...
test("ProjectCardDetails matches the transparent Figma details area", () => {
  ...
  assert.match(markup, /Created 29 days ago/)
})
...
test("ProjectCardDetails no longer reserves title space for the media action", () => {
  const markup = renderToStaticMarkup(
    <ProjectCardDetails
  ...
  assert.doesNotMatch(markup, /dashboard-project-card-title-action-space/)
