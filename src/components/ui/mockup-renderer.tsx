          ...
          {(selectedPage.description || selectedPage.pros.length > 0 || selectedPage.cons.length > 0) && (
            <div className="grid gap-2 md:grid-cols-2">
              {selectedPage.pros.length > 0 && (
                <div className="rounded-md border border-green-200/50 bg-green-50/40 p-2 text-xs dark:border-green-900/50 dark:bg-green-950/20">
                  <p className="mb-1 text-[11px] font-medium text-green-700 dark:text-green-300">Pros</p>
              ...
              {selectedPage.cons.length > 0 && (
                <div className="rounded-md border border-red-200/50 bg-red-50/40 p-2 text-xs dark:border-red-900/50 dark:bg-red-950/20">
                  <p className="mb-1 text-[11px] font-medium text-red-700 dark:text-red-300">Cons</p>
                  <ul className="list-disc list-inside space-y-0.5 text-muted-foreground">
        ...
        <div className="flex items-start gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="ui-row-gap-2 rounded-md border border-border px-4 py-2 text-xs font-medium transition-colors hover:bg-muted/50">
