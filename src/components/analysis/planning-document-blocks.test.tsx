...
`}
  ...
  assert.match(html, /aria-label="Explain Technical Considerations"/)
  ...
  assert.match(html, /aria-label="Explain Risks, Dependencies &amp; Open Questions"/)
...
`}
  ...
  assert.match(html, /aria-label="Explain Risks &amp; Mitigation"/)
  assert.match(html, /R-01/)
  assert.match(html, /R-02/)
  assert.match(html, /Impact/)
  assert.match(html, /aria-label="Explain Impact"/)
  assert.equal(html.match(/aria-label="Explain Impact"/g)?.length, 1)
  assert.match(html, /Mitigation/)
  assert.match(html, /aria-label="Explain Mitigation"/)
  assert.equal(html.match(/aria-label="Explain Mitigation"/g)?.length, 1)
  ...
  assert.match(html, /aria-label="Explain Dependencies"/)
  ...
  assert.match(html, /aria-label="Explain Assumptions"/)
  assert.match(html, /A01/)
  assert.match(html, /A02/)
  assert.match(html, /A03/)
  assert.match(html, /Highest Risk/)
  assert.match(html, /aria-label="Explain Highest Risk"/)
...
`}
  ...
  assert.match(html, /aria-label="Explain Next Prompt"/)
  assert.match(html, /aria-label="Explain AI Build Guardrails"/)
