...
When the active repository contains `brand/README.md`, the repository-integration override in `SKILL.md` keeps canonical brand state in `brand/brand.md` and generated packages under `brand/generated/` instead of Desktop.
