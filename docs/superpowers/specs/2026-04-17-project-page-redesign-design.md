...
|---------|---------|---------|
| **Left** | Red square icon (24x24, corner-radius 4px, `#FF3B30`) with white initial letter (Space Grotesk 13px bold) + App/website name — e.g., "MakerCompass" (`#666666`, Inter 14px medium). This is the **brand wordmark**, not the project name. | `gap: 12px`, horizontal flex |
...
### Behavior
- Left side shows the app brand wordmark (e.g., "MakerCompass"), clickable as a home link to `/dashboard`
