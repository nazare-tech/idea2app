...
| [src/app/page.tsx](src/app/page.tsx) | Landing page with dynamic signup vs waitlist CTA rendering, authenticated-user redirect, a rotating mobile-screen hero reel, and the scroll-driven features section |
