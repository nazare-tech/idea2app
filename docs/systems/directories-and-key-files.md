...
| [src/components/projects/dashboard-project-card.tsx](src/components/projects/dashboard-project-card.tsx) | Interactive project card with hover/touch-aware vertical kebab, arrows, accessible position dots, swipe-safe workspace link, workspace warmup, Rename/Delete menu and dialogs, and Free-plan upgrade prompt |
