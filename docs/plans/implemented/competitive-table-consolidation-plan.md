...
6. Review and remediate.
   - Output: create `docs/plans/implemented/competitive-table-consolidation-review.md` with code review and security review notes, then fix actionable findings.
...
- Review Complete: completed. Code review and security review notes are written in `docs/plans/implemented/competitive-table-consolidation-review.md`; no remediation findings remain.
