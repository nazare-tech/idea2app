...
7. Audit and remove remaining user-facing Generate All and credits UI.
   ...
   - Update `docs/plans/manual-tasks-todo.md` or the closest roadmap checklist with a project-based pricing cleanup item so future work tracks removal of remaining credit-based concepts.
