...
**Last Updated**: 2026-04-12 (Phase 4: AI Project Name + Auth Modal + Accessibility fixes)
...
| [migrations/create_mockups_table.sql](migrations/create_mockups_table.sql) | Database migration for mockups table |
