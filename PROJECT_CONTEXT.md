...
- **Customer Portal Configuration**: The default live portal configuration supports invoice history, customer/payment-method updates, and cancellation. Confirm the deployed production return URL after deployment.
