...
- **AI Prompts Workspace Section**: A derived workspace section rendered after Design Mockups. It does not create a database table, generation queue item, or PDF export type. It renders a Recommended AI Build Tool card above Next Prompt, followed by AI Build Guardrails, AI-Friendly Build Sequence, Functional Requirements, and User Stories & Acceptance Criteria with their own `ai-prompts-*` anchors.
